    ...
    <div class="container">
      ...
      <div class="nav-collapse collapse">
        ...
        <!--  <li><a href="#"><img src="{{asset('images/dashboard/messages.png')}}" alt="" class="top_menu_icon" />Messages</a></li>
          ...
          @endif-->
          <li class="welcome_text"><span>使用者 :</span> <a href="{{url('/dashboard/me')}}">{{Sentry::getUser()->first_name}} {{Sentry::getUser()->last_name}}</a></li>
          <li><a href="{{URL::to('/logout')}}" style="font-size:15px;"><img src="{{asset('assets/images/dashboard/logout.png')}}" alt="" class="top_menu_icon" />登出</a></li>
        </ul>
      </div>
    </div>
  </div>
