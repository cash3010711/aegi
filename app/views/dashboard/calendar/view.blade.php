        ...
        <div class="add-proj-form">
          <fieldset>
            <div class="row-fluid">
              ...
              <div class="advanced_link"><a href="#" id="adv">更多</a></div>
            </div>
            <div id="advanced-inputs">
              <div class="row-fluid event_form_data">
                <div class="control-group">
                  <label class="control-label" for="passwordinput">地點:</label>
                  <div class="controls">
                    <input id="location" name="location" type="text" placeholder="地點">
                  </div>
                </div>
              </div>
            </div>
            ...
            tagsinput = encodeURIComponent(tagsinput);
            window.open(`../app/views/dashboard/send.php?title=${title}&date=${date}&starttime=${starttime}&endtime=${endtime}&category=${category}&note=${note}&tagsinput=${tagsinput}`, 
