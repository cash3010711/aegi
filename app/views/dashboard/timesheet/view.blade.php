  ...
  <div class="main_content">
    <div class="row-fluid">
      <div class="span12 project_detail">
          ...
          <div class="timesheet-form">
            ...
            <div class="input-append">
              <form class="form-vertical" action="{{url('/dashboard/timesheet/entry')}}" method='post' data-validate="parsley">
                ...
                <button class="submit timesheetcustom">尋找</button>
              </form>
            </div>
          </div>
          <a data-toggle="modal" href="#myModal" class="add_project add-last">+ 新增項目</a>
        </div>
        <!-- Time Sheet Detail -->
        ...
        <div class="timesheet-detail-title" id="timesheet-detail-title">顯示 {{ new ExpressiveDate($selectedDate)}} 的項目</div>
...
<div id="myModal" class="modal hide fade cal_light_box" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <form class="form-horizontal" action="{{url('/dashboard/timesheet/entry/add')}}" method='post' data-validate="parsley">
    <div class="modal-header form_modal_header">
      ...
      <h3 id="myModalLabel">
      <input type="text" name="title" id="title" class="popup_title_input" placeholder="工作標題" data-required="true" data-show-errors="false">
      </h3>
    </div>
            ...
            <div class="row-fluid">
              <div class="control-group">
                <div class="row-fluid">
                  ...
                  <input id="starttime" name="starttime" type="text" class="span3 pull-left" placeholder="開始時間" data-required="true" data-trigger="change">
                  <input id="endtime" name="endtime" type="text" class="span3 pull-left" placeholder="結束時間" data-required="true" data-trigger="change">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="passwordinput">任務:</label>
                <div class="controls">
                  <div class="task_select">
                    <select name="task" id="task" tabindex="1" style="width:270px;">
                      ...
                      @else
                      <option  name="" value="others" title="">無任務</option>
                      @endif
                    </select>
                  </div>
                </div>
              ...
              <div class="control-group">
                <label class="control-label" for="details">詳細內容:</label>
                <div class="controls">
                  <textarea  name="details" id="details" class="add-proj-form-t" placeholder="詳細內容"></textarea>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="remarks">備註:</label>
                <div class="controls">
                  <textarea  name="remarks" id="remarks" class="add-proj-form-t" placeholder="備註"></textarea>
                </div>
              </div>
            <button class="submit pull-right">建立工作</a></button>
          </fieldset>
        </div>
      </div>
    </div>
 ...
 <script>
  $(document).on("click", "li", function() {
    ...
    if ($(this).hasClass('c_select')) {
      ...
      $('#timesheet-detail-title').text('顯示 ' + newDate + ' 的項目');
