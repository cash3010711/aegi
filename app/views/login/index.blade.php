...
<body>
     <div class="error_detail_1"><center><img src="{{asset('assets/images/errorpages/logo12.png')}}" alt=""/></center> </div>

<div class="login_detail">
	<h2 class="sign_title">請先登入,謝謝!</h2>
...
<div class="footer">&copy; 2017 CCU SSLAB </div>
