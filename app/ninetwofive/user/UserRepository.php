...
////////////////////////////////changename//////////////////////////////////
    public function updateUsername($data){
        //$checkid =\User::where('userId',$data['userId'])->get()->toArray();
        $checkName = \User::where('last_name',$data['newlast_name'])->get()->toArray();
        $checkName2 = \User::where('first_name',$data['newfirst_name'])->get()->toArray();
        ...
        {
            $user = \Sentry::findUserById($data['userId']);
            $user->last_name = $data['newlast_name'];
            $user->first_name = $data['newfirst_name'];
            $user->save();
            return true;
        }
        catch(\Exception $e)
        {
            \Log::error('Something Went Wrong in User Repository - changeUserName():'. $e->getMessage());
            return false;
        }
    }
}