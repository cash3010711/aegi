...
Route::group(array('prefix'=>'dashboard','before'=>'auth'),function() 
{
				...
				Route::get('/settings','Controllers\Domain\Admin\AdminController@getEmailSettings_general');
				Route::post('/settings','Controllers\Domain\Admin\AdminController@postEmailSettings_general');
